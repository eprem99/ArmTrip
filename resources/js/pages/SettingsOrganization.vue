<template>
    <div class="space-y-6">
        <div>
            <h1 class="text-xl font-semibold text-slate-900">Настройки организации</h1>
            <p class="mt-1 text-sm text-slate-500">
                Название, контакты и отображение даты и времени.
            </p>
        </div>

        <form class="space-y-6" @submit.prevent="save">
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <h2 class="text-sm font-semibold text-slate-900">Основное</h2>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <h2 class="text-sm font-semibold text-slate-900">Контакты</h2>
                <div class="mt-4 space-y-4">
                    <div>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <h2 class="text-sm font-semibold text-slate-900">Дата и время</h2>
                <div class="mt-4 space-y-4">
                    <div>
